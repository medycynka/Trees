...
#ifndef TREES_RBT_HPP
#define TREES_RBT_HPP
...
namespace tree::rbt {
    ...
    public:
        ...
        typedef tree::rbt::node_impl::RBNode<T, Allocator>        node_type;
        typedef tree::rbt::node_impl::RBNode<T, Allocator>*       node_pointer;
        typedef const tree::rbt::node_impl::RBNode<T, Allocator>* const_node_pointer;
        typedef tree::rbt::node_impl::RBNode<T, Allocator>&       node_reference;
        typedef const tree::rbt::node_impl::RBNode<T, Allocator>& const_node_reference;
        typedef typename __gnu_cxx::__alloc_traits<Allocator>::template rebind<node_type>::other node_allocator;
        typedef RBTree<T, Allocator>                                       self_type;
        typedef tree::iterators::Iterator<tree::rbt::node_impl::RBNode<T, Allocator>>             iterator;
        typedef tree::iterators::ConstIterator<tree::rbt::node_impl::RBNode<T, Allocator>>        const_iterator;
        typedef tree::iterators::ReverseIterator<tree::rbt::node_impl::RBNode<T, Allocator>>      reverse_iterator;
        typedef tree::iterators::ConstReverseIterator<tree::rbt::node_impl::RBNode<T, Allocator>> const_reverse_iterator;
    ...
    public:
        ...
        * Constructors
        */
        constexpr RBTree()                                                         : size_{ 0 }, root_{ nullptr } {};
        constexpr explicit RBTree(node_allocator &alloc)                           : size_{ 0 }, root_{ nullptr }, al{alloc} {};
        constexpr RBTree(const RBTree<T, Allocator>& t)                            : size_{ 0 }, root_{ nullptr }, al{t.al.select_on_container_copy_construction()} { copy_(t.root_); };
        constexpr RBTree(const RBTree<T, Allocator>& t, node_allocator &alloc)     : size_{ 0 }, root_{ nullptr }, al{alloc} { copy_(t.root_); };
        constexpr RBTree(RBTree<T, Allocator>&& t) noexcept                        : size_{ 0 }, root_{ nullptr }, al{t.al} { copy_(t.root_); t.clear(); };
        constexpr RBTree(RBTree<T, Allocator>&& t, node_allocator &alloc) noexcept : size_{ 0 }, root_{ nullptr }, al{alloc} { copy_(t.root_); t.clear(); };
        constexpr RBTree(std::initializer_list<T> init)                            : size_{ 0 }, root_{ nullptr } { for (auto& e : init) { insert(e); } };
        constexpr explicit RBTree(std::size_t initSize)                            : size_{ 0 }, root_{ nullptr } { if constexpr (std::is_arithmetic_v<T>){ for (auto i = 0; i < initSize; ++i) { insert(T{i}); } } };
        template<typename InputIt>
        constexpr RBTree(InputIt first, InputIt last)                              : size_{ 0 }, root_{ nullptr } {  while (first != last) {  insert(*first); first++; } };
        ...
        */
        ...
        void                                      copy_from(const RBTree<T, Allocator>& src);
        void                                      copy_from(RBTree<T, Allocator>&& src);
        ...
        * Ostream overloading
        */
        friend std::ostream& operator<<(std::ostream& ofs, const RBTree<T, Allocator>& tree) {
        ...
        */
        ...
        RBTree<T, Allocator>& operator+=(const_reference x)                      { insert(x); return *this; };
        RBTree<T, Allocator>* operator-=(const_reference x)                      { remove(x); return *this; };
        value_type            operator[](const size_t& idx);
        value_type            operator[](const size_t& idx)                 const;
        RBTree<T, Allocator>& operator= (const RBTree<T, Allocator>&);
        RBTree<T, Allocator>& operator= (RBTree<T, Allocator>&&)           noexcept;
        RBTree<T, Allocator>& operator= (std::initializer_list<T> ilist);
        bool                  operator==(const RBTree<T, Allocator>&)      const;
        bool                  operator!=(const RBTree<T, Allocator>& tree) const { return !(*this == tree); };
        bool                  operator< (const RBTree<T, Allocator>& tree) const;
        bool                  operator> (const RBTree<T, Allocator>& tree) const { return tree < *this; };
        bool                  operator<=(const RBTree<T, Allocator>& tree) const { return !(*this > tree); };
        bool                  operator>=(const RBTree<T, Allocator>& tree) const { return !(*this < tree); };
    ...
    inline void RBTree<T, Allocator>::copy_(node_pointer in_node) {
        if (in_node) {
            insert(in_node->key);
            copy_(in_node->left);
            copy_(in_node->right);
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::chop_(node_pointer in_node) {
        if (in_node) {
            chop_(in_node->left);
            chop_(in_node->right);
    ...
    template <typename T, typename Allocator>
    inline RBTree<T, Allocator> &RBTree<T, Allocator>::operator=(const RBTree<T, Allocator>& tree) {
        if (this != &tree) {
            chop_(root_);
            root_ = nullptr;
            size_ = 0;
    ...
    template <typename T, typename Allocator>
    inline RBTree<T, Allocator> &RBTree<T, Allocator>::operator=(RBTree<T, Allocator>&& tree) noexcept {
        chop_(root_);
        root_ = nullptr;
        size_ = 0;
        copy_(tree.root_);
    ...
    template <typename T, typename Allocator>
    RBTree<T, Allocator> &RBTree<T, Allocator>::operator=(std::initializer_list<T> ilist) {
        chop_(root_);
        size_ = 0;
    ...
    template <typename T, typename Allocator>
    inline bool RBTree<T, Allocator>::operator==(const RBTree<T, Allocator>& tree) const {
    ...
    template <typename T, typename Allocator>
    inline T RBTree<T, Allocator>::operator[](const size_t& idx) {
    ...
    template <typename T, typename Allocator>
    inline T RBTree<T, Allocator>::operator[](const size_t& idx) const {
        if (idx < 0 || idx >= size_) throw tree::exception::TreeIndexOutOfBoundException();
        else {
            if (idx == 0) return min_it()->key;
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::insert(const_reference input) {
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::insert_fix_up_(node_pointer new_node) {
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::right_rotation_(node_pointer in_node) {
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::left_rotation_(node_pointer in_node) {
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::find(const_reference val) {
        auto* tmp_node = root_;
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::const_iterator RBTree<T, Allocator>::find(const_reference val) const
    {
        auto* tmp_node = root_;
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::iterator_to(const_reference val) {
        return iterator(node_find(val));
    }

    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::const_iterator RBTree<T, Allocator>::iterator_to(const_reference val) const {
        return const_iterator(node_find(val));
    }

    template <typename T, typename Allocator>
    typename RBTree<T, Allocator>::node_pointer RBTree<T, Allocator>::node_find(const_reference in_node) {
        auto* tmp_node = root_;
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::merge_(node_pointer in_node) {
        if (in_node != nullptr) {
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::split_(node_pointer in_node) {
        if (in_node != nullptr) {
    ...
    template <typename T, typename Allocator>
    [[maybe_unused]] inline size_t RBTree<T, Allocator>::black_height() {
        auto* tmp_node = root_;
        auto num = 0;
    ...
    template <typename T, typename Allocator>
    inline size_t RBTree<T, Allocator>::calculate_size_(node_pointer in_node) {
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::display_(node_pointer in_node, size_t level) {
    ...
    template <typename T, typename Allocator>
    inline bool RBTree<T, Allocator>::remove(const_reference val) {
        if (root_ == nullptr) {
            std::cout << "\nEmpty RBTree.";
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::delete_fix_up_(node_pointer in_node) {
        if (in_node != nullptr) {
            node_pointer successor;
    ...
    template <typename T, typename Allocator>
    inline std::pair<typename RBTree<T, Allocator>::iterator, typename RBTree<T, Allocator>::iterator> RBTree<T, Allocator>::bounded_range(const_reference from, const_reference to) {
        if (from <= to) {
            iterator from_it;
            iterator to_it;
    ...
    template <typename T, typename Allocator>
    inline std::pair<typename RBTree<T, Allocator>::const_iterator, typename RBTree<T, Allocator>::const_iterator> RBTree<T, Allocator>::bounded_range(const_reference from, const_reference to) const {
        if (from <= to) {
    ...
    template <typename T, typename Allocator>
    inline std::pair<typename RBTree<T, Allocator>::iterator, typename RBTree<T, Allocator>::iterator> RBTree<T, Allocator>::equal_range(const_reference val) {
        return { lower_bound(val), upper_bound(val) };
    }

    template <typename T, typename Allocator>
    inline std::pair<typename RBTree<T, Allocator>::const_iterator, typename RBTree<T, Allocator>::const_iterator> RBTree<T, Allocator>::equal_range(const_reference val) const {
        return { lower_bound(val), upper_bound(val) };
    }

    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::lower_bound(const_reference val) {
        for (auto it = begin(); it != end(); ++it) {
            if (*it >= val) {
                return it;
            }
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::const_iterator RBTree<T, Allocator>::lower_bound(const_reference val) const {
        for (const auto it = cbegin(); it != cend(); ++it) {
            if (*it >= val) {
                return it;
            }
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::upper_bound(const_reference val) {
        for (auto it = begin(); it != end(); ++it) {
            if (*it > val) {
                return it;
            }
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::const_iterator RBTree<T, Allocator>::upper_bound(const_reference val) const {
        for (const auto it = cbegin(); it != cend(); ++it) {
            if (*it > val) {
                return it;
            }
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::erase(const_iterator position) {
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::erase(iterator position) {
        auto ret = position;
        ++ret;
        remove(*position);
    ...
    template <typename T, typename Allocator>
    inline typename RBTree<T, Allocator>::iterator RBTree<T, Allocator>::erase(iterator first, iterator last) {
        auto ret = last;
    ...
    template <typename T, typename Allocator>
    inline std::size_t RBTree<T, Allocator>::erase(const_reference key) {
        std::size_t count = 0;
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::swap(reference other) noexcept {
    ...
    template <typename T, typename Allocator>
    template <typename InputIt>
    inline void RBTree<T, Allocator>::insert(InputIt first, InputIt last) {
        while (first != last) {
            insert(*first);
            ++first;
        }
    ...
    template <typename T, typename Allocator>
    inline std::size_t RBTree<T, Allocator>::count(const_reference key) {
        std::size_t count = 0;
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::copy_from(const RBTree<T, Allocator>& src) {
        *this = src;
    }

    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::copy_from(RBTree<T, Allocator>&& src) {
        *this = std::move(src);
    }

    template <typename T, typename Allocator>
    inline std::pair<typename RBTree<T, Allocator>::iterator, bool> RBTree<T, Allocator>::insert_unique(const_reference val) {
        auto check = size();
        insert(val);
    ...
    template <typename T, typename Allocator>
    inline void RBTree<T, Allocator>::replace(const_reference replace_this, const_reference with_this) {
